...
With the \textbf{\chem{CO_2}-Fertilization} scenario, enzyme allocation strategies
...
elevated \chem{CO_2} period, with largest contribution from mineralization by
microbial turnover.
...
in years 10 to 60 with the \chem{CO_2}-Fertilization scenario.
