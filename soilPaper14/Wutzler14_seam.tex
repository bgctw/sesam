...
In the light of the introduction of these additional N mineralisation fluxes,
...
In this experiment initially the N immobilization flux was sufficient to avoid
microbial N limitation ($-\Phi_B < u_{immo,Pot}$). The increased C-inputs
during the period of elevated \chem{CO_2} then shifted the system to
...
SOM under elevated \chem{CO_2} in the following way. There was a net transfer
