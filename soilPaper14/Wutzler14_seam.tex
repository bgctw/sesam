...
Decomposition of the litter and residue pools follows an inverse
...
The \textbf{ExtMax} strategy \citep{Averill14} matches stoichiometry if microbes
...
\chem{CO_2}-Fertilization experiment.
