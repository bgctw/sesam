...
%copied this from the figure legend. I think this deserved a proper explanation in the main text:
%Microbes
...
(Fig. \ref{fig:PrimingDec}\remarkSZ{merge with following figure.}{}). This
...
\end{center}
\caption{The response of the substrate pools to increased litter inputs from years 10 to 60 with the \chem{CO_2}-Fertilisation scenario.
...
\ref{fig:pastureFit} left \remarkSZ{This Figure would be best split in too -
