...
liberate more N from SOM under elevated \chem{CO_2}, but this response was
...
adapts to changed substrate availability in a way to \remarkTW{balance microbe's
revenue of the currently limiting element}{Better word? ``Revenue strategy
assumes that the microbial community adapts in a way to ensure the investment
into enzyme production is proportional to their revenue regarding the currently
limiting element''}.
