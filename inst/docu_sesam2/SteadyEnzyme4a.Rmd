...
to DOM and uptake, $u_C$, again. The composition of respiration and enzymes, $r_{ui}$ is that
of the composition of a mix of uptake, $r_{uC}$ and composition of internal microbial recycling due to starvation, $r_i$. Hence the composition of uptake depends by enzyme turnover on the composition of uptake.
Hence, there is a more involved formula to compute the composition of the uptake flux.
