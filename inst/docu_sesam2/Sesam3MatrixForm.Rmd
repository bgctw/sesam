...
$l$ are  enzyme limitation of decomposition devided by $B$.
...
\\
\operatorname{out}_{I} &= k_{IP}+ l + i_B 
\\
...
enzyme turnover and to $I$ during mineralization in DOM uptake:
$$
\begin{align}
...
here we describe the a maxium immobilization flux, $i_B I$
leaving the $I$ pool to $B$, and parts of it later return to $I$ 
as imbalance flux.
...
Part $1-\nu$ of the decomposition is mineralized during uptake mineraliztion.
...
$$
\begin{align}
T_{I \to B_N} &= \frac{i_B}{\operatorname{out}_{I}} = \frac{i_B}{k_{IP}+ l + i_B}
\\
T_{B_N \to I} &= \frac{\operatorname{out}_{B_NEnzI} + M_{\operatorname{Imb}} }{\operatorname{out}_{B_N}}
\end{align}
$$
