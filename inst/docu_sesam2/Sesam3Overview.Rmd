...
- SESAM3a: enzyme in steady state but explicitely tracking $alpha$
    - SESAM3s: deprecated predecessor with still using parameters km and kN
- SESAM3B: also microbial biomass in steady state
...
scenarios <- tibble::tibble(
  ...
  ,mod = c(derivSeam3a, derivSesam3a, derivSesam3s, derivSesam3B)
