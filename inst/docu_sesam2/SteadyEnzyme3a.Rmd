...
&= \beta_B /\epsilon \left[ \nu (\operatorname{dec}_L/\beta_L + \operatorname{dec}_R/\beta_R + \kappa_E a_E B/\beta_E) + u_{\operatorname{imm,Pot}}- a_E B/\beta_E  \right] \\
&= \beta_B /\epsilon \left[ \nu (\operatorname{dec}_L/\beta_L + \operatorname{dec}_R/\beta_R) + u_{\operatorname{imm,Pot}} - (1 - \nu \kappa_E) a_E B/\beta_E  \right] \\
\\
