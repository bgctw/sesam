...
$$
\text{plant uptake}_{Pot} = \frac{{k_{IN}}_P {E_{IN}}_P \  I_N}{ {k_S}_P f_E + I_N}
\\
immo_{Pot} = \frac{i_B e_B B \  I_N}{{k_S}_B f_E + I_N}
\\
...
by ECA compared to independent potential $I_N$ uptake.
