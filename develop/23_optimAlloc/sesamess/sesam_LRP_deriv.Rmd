...
p2 <- pivot_longer(dsAlpha, !c(dL,Approach,Biomass), names_to="Enzyme") %>% 
  ...
  xlab(bquote('Potential return from depolymerizing labile ('*gC~ m^-2~yr^-1*')')) +
...
For consistency, we need to give a figure (or text?) of 
total respiration, microbial growth, carbon in key model compartments, CUE
