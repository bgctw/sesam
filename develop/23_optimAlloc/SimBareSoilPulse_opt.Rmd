...
extend_CNP_setting <- function(x0, parms, drivers) {
  ...
  x0P <- c( 
        ...
        ,alphaL=unname(x0["alpha"])
        ,alphaR=1- unname(x0["alpha"])
  )
...
resRelCN50  <- simLPulse(x0FixedAlpha, parmsRelative, cn0 = 50)
resRelCN70  <- simLPulse(x0FixedAlpha, parmsRelative, cn0 = 70)
resRelCN90  <- simLPulse(x0FixedAlpha, parmsRelative, cn0 = 90)
resOptCN50  <- simLPulse(x0FixedAlpha, parmsOptimal, cn0 = 50)
resOptCN70  <- simLPulse(x0FixedAlpha, parmsOptimal, cn0 = 70)
resOptCN90  <- simLPulse(x0FixedAlpha, parmsOptimal, cn0 = 90)
...
resP <- rbind(
  ...
  # ,cbind(scen = "fixed community", cn0 = 50, resAlpha30CN30)
  # ,cbind(scen = "fixed community", cn0 = 70, resAlpha30CN70)
